...
public:
	...
	enum class Mode : uint8_t {
		mode0 = SPI_MODE_0, mode1 = SPI_MODE_1, mode2 = SPI_MODE_2, mode3 = SPI_MODE_3
	};

	explicit SPI( const Channel channel = Channel::channel0, const int speed = 1000000, const Mode mode = Mode::mode3 );
	~SPI();
